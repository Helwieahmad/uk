...
<div id="koplak"><p align="center">Di bawah ini adalah List Publikasi Ilmiah Dosen</p></div>
<tr>	
				<td>
...
<table width='617'>
								<tr style="background:#444444; height:35px; font-family:Tahoma, Geneva, sans-serif; font-size:14px; font-weight:bold; color:#ffffff; height:35px;">
									<th width="100%">Publikasi Ilmiah</th>
								...
								$posisi = $p->cariPosisi($batas);
						      	$sql=mysql_query("SELECT * FROM publikasi ORDER BY id_publikasi ASC LIMIT $posisi,$batas");$no = $posisi+1;
           ...
           <?php
		$jmldata = mysql_num_rows(mysql_query("SELECT * FROM publikasi"));
