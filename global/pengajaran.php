...
<div id="koplak"><p align="center">Di bawah ini adalah List Daftar Bidang Pengajaran</p></div>
<tr>	
				<td>
...
<table width='617'>
								<tr style="background:#444444; height:35px; font-family:Tahoma, Geneva, sans-serif; font-size:14px; font-weight:bold; color:#ffffff; height:35px;">
									<th width="100%">Bidang Pengajaran</th>
								...
								$posisi = $p->cariPosisi($batas);
						      	$sql=mysql_query("SELECT * FROM pengajaran ORDER BY id_pengajaran ASC LIMIT $posisi,$batas");$no = $posisi+1;
								while ($data = mysql_fetch_array($sql)){
									?>
									<tr height="30"> 
										<td align="center" hidden><?php echo $no; ?></td>
										<td  style="border-bottom:1px solid #6e6e6f;">&nbsp; <a style="color:#6e6e6f;font-family:Verdana, Geneva, sans-serif; font-size:13px;" href=""><?php echo $data[nama] ; ?></a></td>
									</tr>
									<?php
									$no++;
								}
           ...
           <?php
		$jmldata = mysql_num_rows(mysql_query("SELECT * FROM pengajaran"));
